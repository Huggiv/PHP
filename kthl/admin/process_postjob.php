<?php session_start();
	...
	$msg=array();
	if(empty($_POST['title'])|| empty($_POST['cat'])|| empty($_POST['salary'])|| empty($_POST['experience'])|| empty($_POST['disc'])|| empty($_POST['city']))
	{
	...
	else
	{
		...
		$q="insert into jobs(j_title,j_category,j_salary,j_experience,j_discription,j_city)
		values ('$title','$cat','$salary','$experience','$disc','$city')";
