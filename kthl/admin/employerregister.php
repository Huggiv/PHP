...
<!-- registration -->
	<div class="main-1">
	    ...
	    ?>
		  	  <form action="process_employer_register.php" method="post">
				 ...
				 <div class="wow fadeInLeft" data-wow-delay="0.4s">
							<label for="name">Branch Name</label>
							 <br> <input type="text" name="cnm" size="30" placeholder="Male/Female" required class="form-control">
							 <span class="text-danger"></span>
				 </div>
				 <div class="wow fadeInRight" data-wow-delay="0.4s">
				...
				<!-- <div class="wow fadeInRight" data-wow-delay="0.4s">
						<label for="name">Branch Profile</label>
			   <br> <input type="text" name="profile" size="30" placeholder="Principal/Teacher/Accountant" required class="form-control">
							 <span class="text-danger"></span>
				 </div>-->
